...
const card_form1 = document.getElementById("card_form1");
const card_form2 = document.getElementById("card_form2");
// button 
...
ReturnFlight.addEventListener("click", () => {
    ...
    card_form1.style.display = "none";
    card_form2.style.display = "none";
})
OneWay.addEventListener("click", () => {
    card_form1.style.display = "block";
    card_form.style.display = "none";
    card_form2.style.display = "none";
})
MultiCity.addEventListener("click", () => {
    card_form2.style.display = "block";
    card_form1.style.display = "none";
    card_form.style.display = "none";
})
