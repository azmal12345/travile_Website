...
// car text 
const infoTextShow = "A writing activity to help students construct an informative text based on factual information.";
const infoTextButton = document.getElementById("infoText");
const infoCar = document.getElementById("infoCar");

infoTextButton.addEventListener("mouseenter", () => {
    infoCar.innerHTML = infoTextShow;
    infoCar.classList.add("carInput");
})

infoTextButton.addEventListener("mouseout", () => {
    infoCar.innerHTML = "";
    infoCar.classList.remove("carInput");
})
