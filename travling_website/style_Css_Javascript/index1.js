...
// flag container 
let flagBtn = document.getElementById("flag_btn");
let closeBtn = document.getElementById("iconClose");
let flagContainer = document.getElementById("flag_Container");
// my account 
let myAccountBoxIn = document.getElementById("myAccount");
let myAccountBoxOut = document.getElementById("myAccountPop");
let toggleIconClose = document.querySelector(".timesIcon");
